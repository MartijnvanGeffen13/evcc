				...
				<div class="flex-grow-1 overflow-hidden ring-space">
					...
					<div class="row">
						...
						<template v-if="socSupported(vehicle)">
							...
							<div v-if="vehicle.solarMinSoc" class="col-6 col-lg-3 mb-3">
								<div class="small text-uppercase evcc-gray text-truncate">
									{{ $t("main.vehicleSettings.solarMinSoc") }}
								</div>
								{{ fmtPercentage(vehicle.solarMinSoc) }}
							</div>
							<div v-if="effectiveMinSoc(vehicle)" class="col-6 col-lg-3 mb-3">
								<div class="small text-uppercase evcc-gray text-truncate">
									{{ $t("main.vehicleSettings.effectiveMinSoc") }}
								</div>
